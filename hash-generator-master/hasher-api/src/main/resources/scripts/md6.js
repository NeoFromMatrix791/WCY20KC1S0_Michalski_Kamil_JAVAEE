/**
 *  Source: https://github.com/Snack-X/md6/blob/master/md6.js
 *
...
function _bundle(data, key, levels) {
	return {
		hash128: _hex(data, 128, key, levels),
		hash256: _hex(data, 256, key, levels),
		hash512: _hex(data, 512, key, levels)
	}
}
